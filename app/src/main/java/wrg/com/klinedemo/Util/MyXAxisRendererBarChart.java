...
public class MyXAxisRendererBarChart extends XAxisRenderer {

    protected MyBarChart mChart;

    public MyXAxisRendererBarChart(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans,
                                   MyBarChart chart) {
