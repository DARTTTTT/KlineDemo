...
public class MyXAxisRenderers extends XAxisRenderer {
    private final BarLineChartBase mChart;
    protected MyXAxiss mXAxis;

    public MyXAxisRenderers(ViewPortHandler viewPortHandler, MyXAxiss xAxis, Transformer trans, BarLineChartBase chart) {
