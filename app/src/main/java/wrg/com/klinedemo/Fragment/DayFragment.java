...
public class DayFragment extends BaseFragment {
    ...
    protected void init(View view) {
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry entry, int i, Highlight highlight) {
                ...
                Toast.makeText(getContext(), "最高" + candleEntry.getHigh() + " 最低" + candleEntry.getLow() +
    ...
    public void getEventData(List<KlineEntity.DataBean> klineAlldata) {
        Log.d("print", "getEventData:日K的数据"+klineAlldata.toString());

        if (klineAlldata.get(0).getState().equals("day")) {
            ...
            //axisRightBar.setValueFormatter(new LargeValueFormatter());
            //axisLeftBar.setValueFormatter(new LargeValueFormatter());
            axisLeftBar.setValueFormatter(new VolFormatter((int) Math.pow(100000000, u)));
