...
public class FifteenFragment extends BaseFragment {
    ...
    public void getEventData(List<KlineEntity.DataBean> pastToNowData) {
        if (pastToNowData.get(0).getState().equals("fifteen")) {
            ...
            candleData = generateCandleData(candleEntriesKline, "成交量");
            ...
            axisLeftBar.setValueFormatter(new VolFormatter((int) Math.pow(1000000, u)));
